namespace KanakketuppuUtilityApiServiceCore.ContactServiceCore.Repositories
{
    public static class ContactServiceDBQueries
    {
        ...
        public const string CreateContactDBQuery = "INSERT INTO public.contactqueries (customername, subject, emailaddress, message, status, createdby, createdon, modifiedby, modifiedon, isactive) VALUES (@CustomerName,@Subject,@EmailAddress,@Message,'NEW','ADMIN', @CreatedOn, 'ADMIN', @ModifiedOn, @IsActive) RETURNING Id";
